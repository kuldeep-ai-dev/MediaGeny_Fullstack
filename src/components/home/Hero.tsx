...
export function Hero() {
    return (
        <section className="relative flex min-h-[85vh] flex-col items-center justify-center overflow-hidden px-4 pt-32 pb-20 md:pt-40 md:pb-32 text-center">
            {/* Background Decor */}
            ...
            {/* Heading */}
            <h1 className="mb-6 max-w-4xl text-3xl font-bold tracking-tight md:text-5xl lg:text-6xl animate-in fade-in slide-in-from-bottom-6 duration-700 fill-mode-both delay-100">
                Empowering Your{" "}
